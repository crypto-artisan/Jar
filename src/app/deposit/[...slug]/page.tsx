...
export default function Page({ params }: { params: { slug: string[] } }) {
    ...
    const sendHBAR = async () => {
        try {
            ...
            const recipient = "0xCCD36Ebb9d8711030A589c6bc3430d118c21E4E6"; // Specify recipient address
            // const amount = ethers.utils.parseUnits("30", 18); // Specify amount in HBAR (1 HBAR in this example)
            const amount = ethers.utils.parseUnits(transfer?.assets.toString() || "0", 18); // Specify amount in HBAR (1 HBAR in this example)
